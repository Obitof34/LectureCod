...
public final class FragmentReEggBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentReEggBinding(@NonNull FrameLayout rootView, @NonNull Button button,
  ...
  @NonNull
  public static FragmentReEggBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentReEggBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_re_egg, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentReEggBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentReEggBinding((FrameLayout) rootView, button, editTextNumber, editTextText,
