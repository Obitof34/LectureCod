...
public final class FragmentReFarmBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentReFarmBinding(@NonNull FrameLayout rootView, @NonNull Button button,
  ...
  @NonNull
  public static FragmentReFarmBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentReFarmBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_re_farm, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentReFarmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentReFarmBinding((FrameLayout) rootView, button, editTextNumber, editTextText,
