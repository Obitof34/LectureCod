...
import com.danielme.android.bottomnavigation.fragments.tickets;
...
public class MainActivity extends AppCompatActivity {
  ...
  private boolean onItemSelectedListener(MenuItem item) {
    switch (item.getItemId()) {
      ...
      case R.id.page_fav -> {
        showFragment(new tickets(), R.string.bottom_nav_fav);
        return true;
      }
      ...
      case R.id.page_settings -> {
        showFragment(new Settings() , R.string.bottom_nav_settings);
        return true;
      }
